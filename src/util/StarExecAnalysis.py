'''
Module for comparing benchmark StarExec CPU times with known PEGASUS results
...
def main():
    '''
    Compares StarExec CPU times to known entries in PEGASUS and plots the results
    '''
